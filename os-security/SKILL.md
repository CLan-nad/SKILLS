...
| [references/suid-analysis.md](references/suid-analysis.md) | SUID 五步判定、二进制逆向（checksec/nm/strace）、GTFOBins、PATH 劫持、LD_PRELOAD |
| [references/cap-analysis.md](references/cap-analysis.md) | 能力组合风险矩阵、麒麟组件分析 |
